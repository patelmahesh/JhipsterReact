...
@RestController
@RequestMapping("/api/react-kafka")
public class ReactKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ReactKafkaResource.class);
    ...
    public ReactKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
